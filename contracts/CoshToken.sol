...
contract CoshToken {
    string  public name = "Cosh Token"; //name of the token
    string  public symbol = "COSH"; // symbol of the token
    string  public standard = "Cosh Token v1.0"; // standard of token
    ...
    constructor (uint256 _initialSupply, address addr) public {
        ...
        CT.setNativeTokens(address(this), name, "Cosh Token", _initialSupply);
    }
